...
namespace KGUI
{
	...
	[System.Serializable]
	public class KGUIEventDelegate
	{
		/// <summary>
		...
		public KGUIEventDelegate () { }
		public KGUIEventDelegate (Callback call) { Set(call); }
		public KGUIEventDelegate (MonoBehaviour target, string methodName) { Set(target, methodName); }
		...
		static int s_Hash = "KGUIEventDelegate".GetHashCode();
	...
	// #endif
		...
		static public KGUIEventDelegate Add (List<KGUIEventDelegate> list, Callback callback) { return Add(list, callback, false); }
		...
		static public void Add (List<KGUIEventDelegate> list, KGUIEventDelegate ev) { Add(list, ev, ev.oneShot); }
		...
		static public bool Remove (List<KGUIEventDelegate> list, KGUIEventDelegate ev)
		{
			if (list != null)
			{
				for (int i = 0, imax = list.Count; i < imax; ++i)
